...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LIKE_POST', 'LIKE_COMMENT', 'COMMENT', 'FOLLOW', 'MENTION', 'REPOST');
...
-- CreateIndex
CREATE INDEX "posts_type_is_deleted_created_at_idx" ON "posts"("type", "is_deleted", "created_at" DESC);
